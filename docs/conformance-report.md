...
| 优先级 | 项目 | 预估工作量 | 类型 |
|--------|------|----------|------|
| P3 | 人格商店 WebUI | 2-3 天 | 前端功能 |
| P3 | 记忆图谱可视化 (ECharts) | 2-3 天 | 前端功能 |
| P3 | 流式播放同步 (WebSocket) | 1-2 天 | 前端集成 |
| P3 | 日志聚合 (Loki + Grafana) | 2-3 天 | 运维增强 |
| P3 | yuanbot-testkit 测试框架 | 3-5 天 | 开发工具 |
| P3 | 多语言文档站 (VitePress) | 3-5 天 | 文档 |
| P3 | 社区贡献流水线 (PR→CI→上架) | 2-3 天 | 流程工具 |
